...
class Computer:
    ...
    def __init__(self):
        ...
        # Хранит результата выстрела после певого успешного выстерла и направление относительно него.
        self.was_second_hit = [False, '']
        # Предыдущий вестрел
        self.shooting_cords = [0, 0]
        # Текущая стратегия. 0 - есть все 1 и 2 палубгные. 1 - нет 1 палубных. 2 - нет 1 и 2 палубных
        self.strategy = 0
